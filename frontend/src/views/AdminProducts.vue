            ...
            <div class="modal-overlay">
               ...
               <div class="product-details">
                  ...
                  <input
                     type="text"
                     name="short-desc"
                     v-model="overlayProduct.shortDesc"
                  />
                  ...
                  <input
                     type="text"
                     name="serial"
                     v-model="overlayProduct.serial"
                  />

                  <label for="image">Product Image</label>
                  <select v-model="overlayProduct.imgFile" name="image">
                     <option default value="skateboard-generic.png"
                        >Skateboard Generic</option
                     >
                     <option value="hoodie-ash.png">Hoodie Ash</option>
                     <option value="hoodie-fire.png">Hoodie Fire</option>
                     <option value="skateboard-greta.png"
                        >Skateboard Greta</option
                     >
               ...
               <div class="buttons">
                  ...
                  <button v-if="!newProduct" @click="editProduct('PATCH')">
                     Update
                  </button>
                  <button v-if="!newProduct" @click="deleteProduct">
                     Delete
                  </button>
